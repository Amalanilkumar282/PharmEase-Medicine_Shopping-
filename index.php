        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/PharmEaselogo.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="pharmacies.php">Pharmacies <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>PharmEase</h1>
                    <h5 class="font-white space-xs">Find medicines,pharmacies and coupons for free</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to find</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to find...."> </div>
                            </div>
                            <button onclick="location.href='pharmacies.php'" type="button" class="btn theme-btn btn-lg">Search Medicine</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Medicine</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Select Pharmacy</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>The easiest way to your Medicine</h2>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with medicines from over 345 pharmacies online.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your medicine delivered! Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                     ...
                     <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                           ...
                           <li><a href="#">Choose medicine</a> </li>
                           <li><a href="#">Choose pharmacy</a> </li>
                     ...
                     <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                           <li><a href="#">thiruvanathapuram</a> </li>
                           <li><a href="#">ernakulam</a> </li>
                           <li><a href="#">kozhikode</a> </li>
                           <li><a href="#">mulanthuruthy</a> </li>
                           <li><a href="#">pala</a> </li>
                           <li><a href="#">Kottayam</a> </li>
                           <li><a href="#">nedumangad</a> </li>
                           <li><a href="#">Kakkanad</a> </li>
                           <li><a href="#">fort Kochi</a> </li>
                           <li><a href="#">thalayolaparambu</a> </li>
                        </ul>
                     </div>
                  </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>medicine order and delivery,planned as pharmacy directory</p>
                            <h5>Phone: <a href="tel:+0916282664212">+916282664212</a></h5> </div>
