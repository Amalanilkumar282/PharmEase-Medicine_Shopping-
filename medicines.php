        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/PharmEaselogo.png" alt=""> </a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="pharmacies.php">Choose Medicine</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="medicines.php?res_id=<?php echo $_GET['res_id']; ?>">Select Pharmacy</a></li>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="medicines.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              Medicines<a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of food/dishes
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='medicines.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
